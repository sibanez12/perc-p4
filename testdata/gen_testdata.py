...
for i in range(1):
    ...
    pkt = Ether(dst=nf_mac_map[egress], src=nf_mac_map[ingress]) / \
          Perc_control(flowID=flowID, leave=leave, isForward=isForward, hopCnt=hopCnt, bottleneck_id=bottleneck_id, demand=demand, insert_debug=insert_debug, label_0=label_0, label_1=label_1, label_2=label_2, alloc_0=alloc_0, alloc_1=alloc_1, alloc_2=alloc_2)
    pkt = pad_pkt(pkt, 64)
    print "-------------------------\nInput Pkt: \n-------------------------\n", pkt.show()
