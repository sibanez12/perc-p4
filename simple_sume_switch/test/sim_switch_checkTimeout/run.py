...
# overwrite the timeoutVal (offset 0 from the maxSat extern)
NEW_TIMEOUT = 45000
nftest_regwrite(p4_externs['maxSat']['base_addr'], NEW_TIMEOUT)
...
nftest_regread_expect(p4_externs['maxSat']['base_addr'], NEW_TIMEOUT)
