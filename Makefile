...
install_sdnet: uninstall_sdnet
	...
	cp ${SUME_SDNET}/templates/perc_wrapper/hdl/* ${TARGET}/${SDNET_OUT_DIR}/wrapper/
	cp ${SUME_SDNET}/templates/perc_wrapper/tcl/* ${TARGET}/${SDNET_OUT_DIR}/
	cp ${SUME_SDNET}/templates/perc_wrapper/Makefile ${TARGET}/${SDNET_OUT_DIR}/
